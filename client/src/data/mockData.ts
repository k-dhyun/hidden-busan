...
export const districts: District[] = [
  { id: 'gangseo', label: '강서구', region: '강서구', x: 8.1, y: 64.4 },
  { id: 'sasang', label: '사상구', region: '사상구', x: 35.6, y: 58.5 },
  { id: 'buk', label: '북구', region: '북구', x: 43.3, y: 33.0 },
  { id: 'geumjeong', label: '금정구', region: '금정구', x: 55.7, y: 27.2 },
  { id: 'gijang', label: '기장군', region: '기장군', x: 82.2, y: 19.4 },
  { id: 'dongrae', label: '동래구', region: '동래구', x: 60.9, y: 39.8 },
  { id: 'yeonje', label: '연제구', region: '연제구', x: 61.9, y: 50.4 },
  { id: 'busanjin', label: '부산진구', region: '부산진구', x: 48.5, y: 51.1 },
  { id: 'haeundae', label: '해운대구', region: '해운대구', x: 80.2, y: 43.9 },
  { id: 'suyeong', label: '수영구', region: '수영구', x: 75.8, y: 56.1 },
  { id: 'nam', label: '남구', region: '남구', x: 65.4, y: 63.1 },
  { id: 'dong', label: '동구', region: '동구', x: 50.3, y: 63.9 },
  { id: 'saha', label: '사하구', region: '사하구', x: 33.2, y: 75.0 },
  { id: 'seo', label: '서구', region: '서구', x: 39.8, y: 67.6 },
  { id: 'jung', label: '중구', region: '중구', x: 44.0, y: 72.2 },
  { id: 'yeongdo', label: '영도구', region: '영도구', x: 55.0, y: 78.1 },
];
